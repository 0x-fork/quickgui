...
const activeLinkStyle: JSX.Style = {
...
function Page(props: { title: string; description: string; children?: JSX.Element }) {
  return (
    <View
      style={{
        display: "flex",
...
function Home() {
  return (
    <Page
      ...
      description="The Rust core owns matching, decoded parameters, query parsing, active paths, and a bounded memory history. Solid only renders the returned route chain."
    >
...
function NotFound() {
  ...
  return (
    <Page
      ...
      description={`The core wildcard captured: ${params()["*"] ?? ""}`}
    >
      <Button
