...
func (m *model) rowStyle(selected func() bool) ui.Style {
	return ui.Style{
		...
		Hover:           &ui.Style{BackgroundColor: func() string { return choose(selected(), m.theme().SelectedStrong, m.theme().Hover) }},
		Active:          &ui.Style{BackgroundColor: m.color(func(t theme) string { return t.Active })},
		Transition:      colorTransition,
		BorderRadius:    6,
		Cursor:          "default",
...
func (m *model) buttonStyle(primary bool) ui.Style {
	return ui.Style{
		...
		Color:           func() string { return choose(primary, m.theme().AccentText, m.theme().TextSecondary) },
		BorderWidth:     choose(primary, 0, 1),
		BorderColor:     m.color(func(t theme) string { return t.Border }),
		BorderRadius:    5,
		Hover:           &ui.Style{BackgroundColor: func() string { return choose(primary, m.theme().AccentHover, m.theme().Hover) }},
		Active:          &ui.Style{BackgroundColor: func() string { return choose(primary, m.theme().AccentHover, m.theme().Active) }},
		FontSize:        11,
