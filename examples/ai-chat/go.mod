...
require github.com/egoist/quickgui/go v0.1.5

require github.com/egoist/quickgui/extensions/markdown v0.1.5

require github.com/egoist/quickgui/extensions/editor v0.1.5
