# QuickGUI TypeScript components
...
| Menus | Context Menu, System Context Menu, Menu, Menubar, Navigation Menu, Toolbar |
...
`bun scripts/check-typescript-examples.ts` mounts and disposes all 44 demos against the native host using hidden windows. The Form demo composes Fieldset and Field, matching the other frontends.
