...
import { Button, Text, View, createRenderer, createSignal, type Style } from "@quickgui/ui";
import { Popover, SystemPopover } from "@quickgui/ui/popover";
...
function PopoverExample() {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontSize: 14, fontWeight: 600 }}>Native popover surfaces</Text>
      </View>
            ...
            >
              ...
              >
                ...
                >
                  <PopoverContent
                    kind="System popover"
                    description="It renders through its own renderer on a native child surface and may cross the owner window's edge."
              ...
              >
                ...
                >
                  <PopoverContent
                    ...
                    description="It shares this window's tree and renders above ordinary content without creating another native window."
