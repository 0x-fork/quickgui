...
describe("log parsing", () => {
  test("parses NUL-separated records with bodies and decorations", () => {
    const output =
      record(["a".repeat(40), "aaaaaaa", `${"b".repeat(40)} ${"c".repeat(40)}`, "Ada", "ada@example.com", "1700000000", "Ada", "ada@example.com", "1700000001", "HEAD -> main, origin/main, tag: v1.0", "Merge feature", "Body line 1\n\nBody line 2\n"]) +
      record(["b".repeat(40), "bbbbbbb", "", "Bob", "bob@example.com", "1600000000", "Bob", "bob@example.com", "1600000000", "", "Initial", ""]);
