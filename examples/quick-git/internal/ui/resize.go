...
func resizablePanel(label string, width func() float64, setWidth func(float64), minimum, maximum float64, children gui.Component, style gui.StyleBuilder) *native.
	...
	return gui.Splitter.Root(
		...
		func() *native.Node {
			return gui.Fragment([]*native.Node{gui.Splitter.Pane(
