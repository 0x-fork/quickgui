...
export function themeFor(appearance: AppearanceMode): Theme {
  if (appearance === "light") {
    return {
      ...
      graph: ["#2f6bff", "#1a9e63", "#d0432f", "#b56cd8", "#e08a1e", "#1b9fb7", "#c74f9d", "#6d7fd6"],
      scrim: "#1a1a2266",
      input: "#ffffff",
...
export function createStyles(theme: Theme) {
  ...
  return {
    ...
    tinyButton: {
      ...
      backgroundColor: theme.appearance === "light" ? "#ffffff" : "#5a5a5e",
      color: theme.text,
      boxShadow: theme.appearance === "light" ? "0 0 0 0.5px #00000024, 0 0.5px 1.5px #0000001f" : "0 0 0 0.5px #ffffff1a",
      fontSize: 11,
      fontWeight: 400,
      cursor: "default",
      userSelect: "none",
    ...
    input: {
      ...
      focus: { borderColor: theme.accent, outline: `3px solid ${theme.focusRing}` },
    ...
    dialogDescription: { fontSize: 12.5, lineHeight: 18, color: theme.textSecondary } satisfies Style,
    ...
    emptyTitle: { fontSize: 15, fontWeight: 500, color: theme.textTertiary, textAlign: "center" } satisfies Style,
    emptyCopy: { fontSize: 12, lineHeight: 17, color: theme.textTertiary, textAlign: "center", maxWidth: 360 } satisfies Style,
  };
}
