...
function Counter() {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontWeight: 600 }}>QuickGUI · Solid 2</Text>
      </View>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 28, lineHeight: 36, fontWeight: 700 }}>
            Fine-grained native UI
          </Text>
          <Text style={{ color: "#94a3b8", fontSize: 14, lineHeight: 21 }}>
            Solid updates only the changed text node. QuickGUI retains layout, sleeps while clean,
            and redraws once for the mutation batch.
          </Text>
          <Text style={{ color: "#bfdbfe", fontSize: 20, fontWeight: 600 }}>
            Count: {count()}
          </Text>
          <Button
