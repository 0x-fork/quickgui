										...
										ui.CalendarDayProps{
											...
											PartProps: ui.PartProps{Style: func() ui.Style {
												return ui.Style{
													...
													Color:           choose(selected(), p().OnAccent, choose(strings.HasPrefix(date, month()), p().Ink, p().Faint)),
													FontSize:        11,
													Hover:           &ui.Style{BackgroundColor: choose(selected(), p().Accent, p().ControlHover)},
