		...
		ui.Meter.Root(
			...
			func() {
				...
				ui.Meter.Track(
					gaugeTrack(),
					func() {
						ui.Meter.Indicator(ui.PartProps{Style: func() ui.StyleBuilder {
							value := level()[0]
							return ui.Style().
								Height(8).
								BorderRadius(4).
		...
		ui.Progress.Root(
			...
			func() {
				...
				ui.Progress.Track(
					gaugeTrack(),
					func() {
						ui.Progress.Indicator(ui.PartProps{Style: func() ui.StyleBuilder {
							return ui.Style().
								Height(8).
								BorderRadius(4).
								BackgroundColor(p().Accent).
...
func RadioDemo() {
	...
	radio := func(value string, selected func() bool, caption string) {
		ui.Radio.Root(
			...
			func() {
				ui.Radio.Indicator(ui.PartProps{Style: func() ui.StyleBuilder {
					return ui.Style().
						Width(15).
						Height(15).
						BorderRadius(8).
...
func switchControl(checked func() bool, set func(bool), readOnly bool, caption string) {
	row(func() {
		ui.Switch.Root(
			...
			func() {
				ui.Switch.Thumb(ui.PartProps{Style: func() ui.StyleBuilder {
					return ui.Style().
						Width(20).
						Height(20).
						BorderRadius(10).
