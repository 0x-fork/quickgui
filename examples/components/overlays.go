...
func menuRow() ui.PartProps {
	return ui.PartProps{Style: ui.Style().Merge(controlStyle()).JustifyContent("space-between").BackgroundColor("transparent").BorderWidth(0).Height(28).BorderRadius(5).PaddingLeft(10).PaddingRight(10).Hover(func(s ui.StyleBuilder) ui.StyleBuilder {
...
func ContextMenuDemo() *ui.Element {
	...
	target := func() ui.ContextMenuTriggerProps {
		return ui.ContextMenuTriggerProps{PartProps: ui.PartProps{Style: ui.Style().Display("flex").Height(64).BorderRadius(10).BorderWidth(1).BorderColor(color(func(p palette) string {
			return p.Border
		})).BorderStyle("dashed").AlignItems("center").JustifyContent("center").BackgroundColor(color(func(p palette) string {
			return p.PanelAlt
		}))}}
	}
	return panel("Context menu", "Secondary-click menus from a declared row model or from Menu.Item parts.", func() *native.Node {
		return ui.Fragment([]*native.Node{func() *native.Node {
			...
			return contextMenu15.Root().Children(func() *native.Node {
				return contextMenu15.Trigger(target()).Children("Right-click: declared rows").NativeNode()
			}).NativeNode()
		}(), func() *native.Node {
			...
			return contextMenu16.Root().Children(func() *native.Node {
				return contextMenu16.Trigger(target()).Children(func() *native.Node {
					return ui.Fragment([]*native.Node{contextMenu16.Item(ui.MenuItemProps{
						Value: "rename",
						Label: "Rename",
					}).NativeNode(), contextMenu16.Item(ui.MenuItemProps{
						Value: "duplicate",
						Label: "Duplicate",
					}).NativeNode(), contextMenu16.Separator(ui.PartProps{}).NativeNode(), contextMenu16.Item(ui.MenuItemProps{
						Value: "delete",
						Label: "Delete",
					}).NativeNode(), muted("Right-click: Menu.Item parts").Node})
				}).NativeNode()
			}).NativeNode()
		}(), note(func() string {
...
func SystemContextMenuDemo() *ui.Element {
	...
	open := func() {
		...
		setStatus("open")
		window.PopupMenu([]native.MenuItem{{Label: "Open", Click: func() {
			setAction("Open")
		}}, {Label: "Rename", Click: func() {
			setAction("Rename")
		}}, {Type: "separator"}, {Label: "Show hidden files", Checked: showHidden(), Click: func() {
			setShowHidden(!showHidden())
			setAction("Show hidden files " + choose(showHidden(), "on", "off"))
		}}, {Label: "Sort by", Items: sortItems}, {Type: "separator"}, {Label: "Unavailable action", Enabled: ptr(false)}}, nil, func(err error) {
			if err != nil {
	...
	return panel("System context menu", "The operating system draws this menu. Actions update the readout below; reopen it to see the current checkmarks.", func() *native.Node {
		return ui.Fragment([]*native.Node{ui.View().Child("Right-click here for the system menu").Display("flex").Height(96).AlignItems("center").JustifyContent("center").BorderRadius(10).BorderWidth(1).BorderStyle("dashed").BorderColor(color(func(p palette) string {
			return p.Border
			...
			open()
		}).Node, row(func() *ui.Element {
			return button("Open system menu", open)
		}).Node, note(func() string {
...
func MenuDemo() *ui.Element {
	...
	item := func(menu *ui.MenuComponent, value, caption string) *native.Node {
		...
		return menu.Item(ui.MenuItemProps{Value: value, Label: caption, PartProps: props}).Child(func() *ui.Element {
	...
	return panel("Menu", "Styled rows with keyboard navigation, checkbox state, radio exclusivity, and a nested submenu.", func() *native.Node {
		return ui.Fragment([]*native.Node{func() *native.Node {
			...
			return menu17.Root().Children(func() *native.Node {
				return ui.Fragment([]*native.Node{menu17.Trigger(ui.MenuTriggerProps{PartProps: control()}).Children("Edit ▾").NativeNode(), menu17.Positioner(ui.MenuPositionerProps{}).Children(func() *native.Node {
					return menu17.Popup(popup(250)).Children(func() *native.Node {
						var children []*native.Node
						children = append(children, menu17.GroupLabel(ui.MenuGroupLabelProps{
							Value: "clipboard",
							Label: "Clipboard",
						}).Children("Clipboard").NativeNode())
						...
						children = append(children, menu17.Separator(ui.PartProps{Style: ui.Style().Height(1).BackgroundColor(color(func(p palette) string {
							return p.Border
						}))}).NativeNode())
						children = append(children, menu17.CheckboxItem(ui.MenuCheckboxItemProps{
							...
							return ui.Fragment([]*native.Node{menuLabel("Wrap lines").Node, menu17.CheckboxItemIndicator(ui.PartProps{}).Children("✓").NativeNode()})
						}).NativeNode())
						children = append(children, menu17.RadioGroup(ui.MenuRadioGroupProps{
							...
							for _, value := range []string{"compact", "cozy", "comfortable"} {
								children = append(children, menu17.RadioItem(ui.MenuRadioItemProps{MenuItemProps: ui.MenuItemProps{
									...
									return ui.Fragment([]*native.Node{menuLabel(value).Node, menu17.RadioItemIndicator(ui.PartProps{}).Children("●").NativeNode()})
								}).NativeNode())
							}
							return ui.Fragment(children)
						}).NativeNode())
						children = append(children, menu17.SubmenuRoot(ui.MenuRootProps{CloseDelay: 100}).Children(func() *native.Node {
							return ui.Fragment([]*native.Node{menu17.SubmenuTrigger(ui.MenuSubmenuTriggerProps{
								Value: "recent",
								Label: "Open recent",
							...
							}).NativeNode(), menu17.Positioner(ui.MenuPositionerProps{
								Side:       "right",
								Align:      "start",
								SideOffset: ptr(4.0),
							}).Children(func() *native.Node {
								return menu17.Popup(popup(200)).Children(func() *native.Node {
									return ui.Fragment(
...
func MenubarDemo() *ui.Element {
	...
	}{{"File", []ui.MenuItemDeclaration{{ID: "new", Label: "New window", Shortcut: "⌘N"}, {ID: "open", Label: "Open…", Shortcut: "⌘O"}, {Type: "separator"}, {ID: "close", Label: "Close", Shortcut: "⌘W"}}}, {"Edit", []ui.MenuItemDeclaration{{ID: "undo", Label: "Undo", Shortcut: "⌘Z"}, {ID: "redo", Label: "Redo", Shortcut: "⇧⌘Z"}, {Type: "separator"}, {ID: "paste", Label: "Paste", Shortcut: "⌘V"}}}, {"View", []ui.MenuItemDeclaration{{ID: "zoom-in", Label: "Zoom in"}, {ID: "zoom-out", Label: "Zoom out"}}}}
	return panel("Menubar", "One roving Tab stop. Arrow keys switch menus while open; Escape closes without leaving the bar.", func() *native.Node {
		return ui.Fragment([]*native.Node{func() *native.Node {
			...
			return menubar18.Root().Children(func() *native.Node {
				var children []*native.Node
				for index, menu := range menus {
					children = append(children, func() *native.Node {
						...
						return popoverMenu19.Root().Children(func() *native.Node {
							return ui.Fragment([]*native.Node{popoverMenu19.Trigger(ui.PartProps{}).Children(func() *native.Node {
								return menubar18.Item(ui.MenubarItemProps{
									Index: ptr(index),
									PartProps: togglePart(func() bool {
										return open() != nil && *open() == index
									}),
								}).Children(menu.label).NativeNode()
							}).NativeNode(), popoverMenu19.Popup(ui.PopoverMenuPopupProps{PartProps: popup(220)}).NativeNode()})
						}).NativeNode()
					}())
				}
				return ui.Fragment(children)
...
func NavigationMenuDemo() *ui.Element {
	...
	return panel("Navigation menu", "Hover opens a panel after the declared delay. The navigation landmark has one Tab stop and reports activation direction.", func() *native.Node {
		return ui.Fragment([]*native.Node{func() *native.Node {
			...
			return navigationMenu20.Root().Children(func() *native.Node {
				return navigationMenu20.List(rowPart()).Children(func() *native.Node {
					var children []*native.Node
					for _, item := range items {
						children = append(children, navigationMenu20.Item(ui.NavigationMenuItemProps{Value: item.Value}).Children(func() *native.Node {
							var children []*native.Node
							props := togglePart(func() bool {
								return value() != nil && *value() == item.Value
							})
							props.Disabled = item.Disabled
							children = append(children, navigationMenu20.Trigger(ui.NavigationMenuPartProps{PartProps: props}).Children(item.Value).NativeNode())
							children = append(children, navigationMenu20.Positioner(ui.NavigationMenuPartProps{}).Children(func() *native.Node {
								return navigationMenu20.Popup(ui.NavigationMenuPartProps{PartProps: popup(230)}).Children(func() *native.Node {
									return navigationMenu20.Viewport(ui.NavigationMenuPartProps{}).Children(func() *native.Node {
										return navigationMenu20.Content(ui.NavigationMenuPartProps{PartProps: columnPart()}).Children(func() *native.Node {
											return ui.Fragment([]*native.Node{navigationMenu20.Link(ui.NavigationMenuLinkProps{
												Value:  item.Value + "-overview",
												Active: true,
											}).Children(item.Value + " overview").NativeNode(), navigationMenu20.Link(ui.NavigationMenuLinkProps{Value: item.Value + "-pricing"}).Children(item.Value + " pricing").NativeNode()})
										}).NativeNode()
									}).NativeNode()
								}).NativeNode()
							}).NativeNode())
...
func PopoverDemo() *ui.Element {
	...
	return panel("Popover", "Preferred placement adapts to the available space. Compare click and delayed hover triggers.", func() *native.Node {
		return ui.Fragment([]*native.Node{func() *native.Node {
			...
			return popover21.Root().Children(func() *native.Node {
				var children []*native.Node
				children = append(children, popover21.Trigger(ui.PopoverTriggerProps{PartProps: control()}).Children("Account").NativeNode())
				placement := ui.UsePopoverPlacement()
				children = append(children, note(func() string {
					return "resolved " + placement().Side + "/" + placement().Align
				}).Node)
				children = append(children, popover21.Positioner(ui.PopoverPositionerProps{}).Children(func() *native.Node {
					return popover21.Popup(ui.PopoverPopupProps{PartProps: popup(240)}).Children(func() *native.Node {
						return ui.Fragment([]*native.Node{popover21.Arrow(ui.PartProps{Style: ui.Style().Width(10).Height(10).BackgroundColor(color(func(p palette) string {
							return p.Popup
						}))}).NativeNode(), popover21.Title(ui.PartProps{}).Children("Signed in").NativeNode(), popover21.Viewport(ui.PartProps{}).Children("ada@example.com").NativeNode(), popover21.Close(control()).Children("Done").NativeNode()})
					}).NativeNode()
				}).NativeNode())
				return ui.Fragment(children)
			}).NativeNode()
			...
			return popover22.Root().Children(func() *native.Node {
				return ui.Fragment([]*native.Node{popover22.Trigger(ui.PopoverTriggerProps{PartProps: control()}).Children("Hover to open").NativeNode(), popover22.Positioner(ui.PopoverPositionerProps{}).Children(func() *native.Node {
					return popover22.Popup(ui.PopoverPopupProps{PartProps: popup(200)}).Children("Opened after the hover delay.").NativeNode()
				}).NativeNode()})
			}).NativeNode()
		}(), note(func() string {
...
func PreviewCardDemo() *ui.Element {
	...
	return panel("Preview card", "Rest the pointer to preview. Keyboard focus opens immediately.", func() *native.Node {
		return ui.Fragment([]*native.Node{row(func() *native.Node {
			return ui.Fragment([]*native.Node{muted("Written by").Node, func() *native.Node {
				...
				return previewCard23.Root().Children(func() *native.Node {
					return ui.Fragment([]*native.Node{previewCard23.Trigger(ui.PreviewCardTriggerProps{
						Delay:      350,
						CloseDelay: 200,
						PartProps: ui.PartProps{Style: ui.Style().Padding(2).TextColor(color(func(p palette) string {
							return p.Accent
						})).TextDecorationLine("underline")},
					}).Children("@ada").NativeNode(), previewCard23.Positioner(ui.PartProps{}).Children(func() *native.Node {
						return previewCard23.Popup(popup(240)).Children(func() *native.Node {
							return ui.Fragment([]*native.Node{label("Ada Lovelace").Node, muted("Wrote the first algorithm intended for a machine.").Node})
						}).NativeNode()
					}).NativeNode()})
				}).NativeNode()
			}()})
...
func toastDemoBody(notifications *ui.ToastComponent) *ui.Element {
	...
	return panel("Toast", "Info, success, and error notifications with update, close, swipe, and automatic dismissal. Stack geometry comes from the core.", func() *native.Node {
		return ui.Fragment([]*native.Node{row(func() *native.Node {
			...
			return ui.Fragment(children)
		}).Node, notifications.Viewport(ui.ToastViewportProps{PartProps: ui.PartProps{Style: ui.Style().Display("flex").FlexDirection("column").Gap(8).MinHeight(40)}}).Child(func() *native.Node {
			return ui.KeyedFor(
				manager.Stack,
				...
				func(entry func() ui.ToastStackEntry, _ func() int) *native.Node {
					...
					return notifications.Positioner(ui.ToastPartProps{ToastID: id}).Child(func() *native.Node {
						return notifications.Root(ui.ToastPartProps{
							...
							return notifications.Content(ui.ToastPartProps{ToastID: id}).Child(func() *native.Node {
								return ui.Fragment([]*native.Node{row(func() *native.Node {
									return ui.Fragment([]*native.Node{notifications.Title(ui.ToastPartProps{ToastID: id}).Child(func() *ui.Element {
										return label(func() string {
											return current().Title
										})
									}).NativeNode(), muted(func() string {
										return "#" + strconv.Itoa(entry().Index) + " · +" + strconv.FormatFloat(entry().Offset, 'g', -1, 64) + "px"
									}).Node, notifications.Close(ui.ToastPartProps{
										ToastID:   id,
										PartProps: ui.PartProps{AriaLabel: "Dismiss notification"},
									}).Child("×").NativeNode()})
								}).Node, notifications.Description(ui.ToastPartProps{ToastID: id}).Child(func() *ui.Element {
...
func TooltipDemo() *ui.Element {
	...
	return panel("Tooltip", "A provider shares a warm delay across triggers. The second tooltip tracks the horizontal cursor position.", func() *native.Node {
		return ui.Fragment([]*native.Node{ui.NewTooltipProvider(ui.TooltipProviderProps{
			Delay:      500,
			CloseDelay: 120,
			Timeout:    400,
		}).Root().Child(func() *ui.Element {
			return row(func() *native.Node {
				...
				for i, caption := range []string{"Hover me", "Tracks the cursor"} {
					...
					children = append(children, func() *native.Node {
						...
						return tooltip25.Root().Children(func() *native.Node {
							return ui.Fragment([]*native.Node{tooltip25.Trigger(ui.TooltipTriggerProps{PartProps: control()}).Children(caption).NativeNode(), tooltip25.Positioner(ui.TooltipPositionerProps{}).Children(func() *native.Node {
								s := popupStyle()
								...
								s = s.Padding(8)
								s = s.FontSize(11)
								return tooltip25.Popup(ui.PartProps{Style: s}).Children(func() *native.Node {
									var children []*native.Node
									children = append(children, ui.Text(choose(i == 0, "Shared hover delay", "Tracks the horizontal cursor")).Node)
									if i == 0 {
										children = append(children, tooltip25.Arrow(ui.PartProps{Style: ui.Style().Width(8).Height(8).BackgroundColor(color(func(p palette) string {
											return p.Ink
										}))}).NativeNode())
									}
									return ui.Fragment(children)
