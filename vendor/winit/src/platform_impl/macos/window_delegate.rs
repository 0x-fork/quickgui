    ...
    autoreleasepool(|_| {
        ...
        let window: Retained<NSWindow> = if attrs.platform_specific.panel {
            ...
            let window: Option<Retained<WinitPanel>> = unsafe {
                msg_send_id![
                    super(mtm.alloc().set_ivars(WinitPanelIvars::default())),
...
impl WindowDelegate {
    ...
    fn handle_scale_factor_changed(&self, scale_factor: CGFloat) {
        ...
        app_delegate.handle_window_event(window_id(window), WindowEvent::Resized(physical_size));
    }
    ...
    pub fn request_redraw(&self) {
        self.ivars()
            .app_delegate
            .queue_redraw(window_id(self.window()));
    }
...
impl WindowExtMacOS for WindowDelegate {
    ...
    fn set_panel_can_become_key_window(&self, can_become_key_window: bool) -> bool {
        ...
        // SAFETY: The runtime class check above proves that the retained NSWindow is our panel
        // subclass for the duration of this borrow.
