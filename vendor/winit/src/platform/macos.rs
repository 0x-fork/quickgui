...
pub trait WindowExtMacOS {
    ...
    /// Set whether an AppKit panel may become the key window after pointer interaction.
    ///
    /// Returns `false` for ordinary `NSWindow` instances. Interactive suggestion panels use this
...
pub trait WindowAttributesExtMacOS {
    ...
    /// Use an AppKit `NSPanel` with the nonactivating-panel style instead of `NSWindow`.
    ///
    /// This is intended for transient launchers, menus, and popup windows that may become key
