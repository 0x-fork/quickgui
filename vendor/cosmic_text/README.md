...
This is QuickGUI's versioned support fork of Cosmic Text 0.19.0. It preserves the upstream API and
adds ordered per-style fallback families to owned attributes, shaping, and cache identity. The
published package is named `quickgui-cosmic-text`; its Rust library name remains `cosmic_text`.
