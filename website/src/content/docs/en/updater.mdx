...
See the [runnable example](https://github.com/egoist/quickgui/tree/main/examples/updater) and [native extension contract](https://github.com/egoist/quickgui/blob/main/docs/architecture/extensions.md). Sparkle configuration and appcast details are documented by [Sparkle](https://sparkle-project.org/documentation/).
