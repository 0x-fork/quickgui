export const site = {
  name: "QuickGUI",
  tagline: "Build native desktop apps with Go or MoonBit.",
  description:
    "Build native desktop apps with Go or MoonBit. Fast builds, fine-grained reactivity, GPU rendering, familiar layouts, and accessible components.",
  ...
  links: {
    ...
    architecture: "https://github.com/egoist/quickgui/blob/main/docs/architecture/README.md",
