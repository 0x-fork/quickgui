...
func (toolbarAPI) Item(props ToolbarItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToolbarItem(protocol.PartToolbarItem, props)
}

func (toolbarAPI) Button(props ToolbarItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToolbarItem(protocol.PartToolbarButton, props)
}

func (toolbarAPI) Link(props ToolbarItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToolbarItem(protocol.PartToolbarLink, props)
}

func (toolbarAPI) Input(props ToolbarInputProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (toolbarAPI) Group(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (toolbarAPI) Separator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
