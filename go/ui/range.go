...
func (sliderAPI) Label(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSliderPart(protocol.PartSliderLabel, props)
}

func (sliderAPI) Value(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSliderPart(protocol.PartSliderValue, props)
}

func (sliderAPI) Control(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSliderPart(protocol.PartSliderControl, props)
}

func (sliderAPI) Track(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSliderPart(protocol.PartSliderTrack, props)
}

func (sliderAPI) Range(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSliderPart(protocol.PartSliderRange, props)
}

func (sliderAPI) Indicator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSliderPart(protocol.PartSliderIndicator, props)
}

func (sliderAPI) Thumb(props SliderThumbProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (splitterAPI) Pane(props SplitterPaneProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createSplitterPart(protocol.PartSplitterPane, props)
}

func (splitterAPI) Handle(props SplitterPaneProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
