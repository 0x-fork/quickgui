...
func (progressAPI) Track(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createGaugePart(protocol.PartProgressTrack, props)
}

func (progressAPI) Indicator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createGaugePart(protocol.PartProgressIndicator, props)
}

func (progressAPI) Label(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createGaugePart(protocol.PartProgressLabel, props)
}

func (progressAPI) Value(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (meterAPI) Track(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createGaugePart(protocol.PartMeterTrack, props)
}

func (meterAPI) Indicator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createGaugePart(protocol.PartMeterIndicator, props)
}

func (meterAPI) Label(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createGaugePart(protocol.PartMeterLabel, props)
}

func (meterAPI) Value(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
