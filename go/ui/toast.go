...
func (toastAPI) Portal(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (toastAPI) Viewport(props ToastViewportProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (toastAPI) Positioner(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToastPart(protocol.PartToastPositioner, props, false)
}

func (toastAPI) Root(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToastPart(protocol.PartToast, props, false)
}

func (toastAPI) Content(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToastPart(protocol.PartToastContent, props, false)
}

func (toastAPI) Title(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToastPart(protocol.PartToastTitle, props, false)
}

func (toastAPI) Description(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToastPart(protocol.PartToastDescription, props, false)
}

func (toastAPI) Action(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createToastPart(protocol.PartToastAction, props, true)
}

func (toastAPI) Close(props ToastPartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
