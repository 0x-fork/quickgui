...
func (popoverMenuAPI) Trigger(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (popoverMenuAPI) Popup(props PopoverMenuPopupProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (contextMenuAPI) Trigger(props ContextMenuTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) SubmenuRoot(props MenuRootProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuRoot(true, props)
}

func (menuAPI) Trigger(props MenuTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) SubmenuTrigger(props MenuSubmenuTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) Portal(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.Portal", protocol.PartMenuPortal, props)
}

func (menuAPI) Positioner(props MenuPositionerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) Backdrop(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.Backdrop", protocol.PartMenuBackdrop, props)
}

func (menuAPI) Popup(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.Popup", protocol.PartMenuPopup, props)
}

func (menuAPI) Arrow(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.Arrow", protocol.PartMenuArrow, props)
}

func (menuAPI) Group(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.Group", protocol.PartMenuGroup, props)
}

func (menuAPI) GroupLabel(props MenuGroupLabelProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) Separator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.Separator", protocol.PartMenuSeparator, props)
}

func (menuAPI) Item(props MenuItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuItem("Menu.Item", protocol.PartMenuItem, props, declareNothing, ignoreItemReport)
}

func (menuAPI) LinkItem(props MenuLinkItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) CheckboxItem(props MenuCheckboxItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) CheckboxItemIndicator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createMenuPart("Menu.CheckboxItemIndicator", protocol.PartMenuCheckboxItemIndicator, props)
}

func (menuAPI) RadioGroup(props MenuRadioGroupProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) RadioItem(props MenuRadioItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menuAPI) RadioItemIndicator(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (menubarAPI) Item(props MenubarItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
