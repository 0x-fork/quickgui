...
func bindCivilDate(node *native.Node, code uint16, value any) {
	...
	switch typed := value.(type) {
	case func() float64:
		node.Bind(func() { write(typed()) })
	case reactive.Accessor[float64]:
		node.Bind(func() { write(typed()) })
	case func() int64:
		node.Bind(func() { write(float64(typed())) })
	case float64:
		write(typed)
	case int64:
		write(float64(typed))
...
func (swiftUIAPI) Host(props SwiftUIHostProps, children ...any) *native.Node {
...
func (swiftUIAPI) Button(props SwiftUIButtonProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (swiftUIAPI) QuickGUIHostView(props SwiftUIQuickGUIHostViewProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
	...
	native.Dispatch(func() {
		...
		decorated := false
		shadow := false
		embedded = native.NewEmbeddedWindow(
			parent,
...
func (swiftUIPopoverAPI) Root(props SwiftUIPopoverProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (swiftUIPopoverAPI) Trigger(props SwiftUIPopoverTriggerProps) *native.Node {
	...
	insertChildren(node, props.Render)
	if props.Ref != nil {
		var rendered *native.Node
...
func (swiftUIPopoverAPI) Content(props SwiftUIPopoverContentProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (swiftUIAPI) PopoverContent(props SwiftUIPopoverContentProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
