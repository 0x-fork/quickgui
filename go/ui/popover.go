...
func createSystemContent(props PopoverContentProps, state *popoverState) *native.Node {
	...
	native.Dispatch(func() {
		...
		window := reactive.RunWithOwner(owner, func() *native.Window {
			return native.NewWindow(native.WindowOptions{
...
func (popoverAPI) Trigger(props PopoverTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverTrigger(props)
}

func (popoverAPI) Content(props PopoverContentProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (popoverAPI) Portal(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverPart(protocol.PartPopoverPortal, "Popover.Portal", props)
}

func (popoverAPI) Backdrop(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverPart(protocol.PartPopoverBackdrop, "Popover.Backdrop", props)
}

func (popoverAPI) Positioner(props PopoverPositionerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (popoverAPI) Popup(props PopoverPopupProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (popoverAPI) Arrow(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverPart(protocol.PartPopoverArrow, "Popover.Arrow", props)
}

func (popoverAPI) Viewport(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverPart(protocol.PartPopoverViewport, "Popover.Viewport", props)
}

func (popoverAPI) Title(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverPart(protocol.PartPopoverTitle, "Popover.Title", props)
}

func (popoverAPI) Description(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverPart(protocol.PartPopoverDescription, "Popover.Description", props)
}

func (popoverAPI) Close(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (systemPopoverAPI) Trigger(props PopoverTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createPopoverTrigger(props)
}

func (systemPopoverAPI) Content(props PopoverContentProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
