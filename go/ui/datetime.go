...
func (dateFieldAPI) Segment(props DateFieldSegmentProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (timeFieldAPI) Segment(props TimeFieldSegmentProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (calendarAPI) Week(props CalendarWeekProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (calendarAPI) Day(props CalendarDayProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
