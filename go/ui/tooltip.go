...
func (tooltipAPI) Root(props TooltipRootProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tooltipAPI) Trigger(props TooltipTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tooltipAPI) Positioner(props TooltipPositionerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tooltipAPI) Portal(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createTooltipPart("Tooltip.Portal", protocol.PartTooltipPortal, props)
}

func (tooltipAPI) Popup(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createTooltipPart("Tooltip.Popup", protocol.PartTooltipPopup, props)
}

func (tooltipAPI) Arrow(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (previewCardAPI) Trigger(props PreviewCardTriggerProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
