...
func (avatarAPI) Image(props AvatarImageProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (avatarAPI) Fallback(props AvatarFallbackProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (scrollAreaAPI) Viewport(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createScrollAreaPart("ScrollArea.Viewport", protocol.PartScrollAreaViewport, props)
}

func (scrollAreaAPI) Content(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)

	return createScrollAreaPart("ScrollArea.Content", protocol.PartScrollAreaContent, props)
}

func (scrollAreaAPI) Scrollbar(props ScrollAreaScrollbarProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (scrollAreaAPI) Thumb(props ScrollAreaThumbProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (scrollAreaAPI) Corner(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (otpFieldAPI) Input(props OtpFieldInputProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (otpFieldAPI) Separator(props OtpFieldSeparatorProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (navigationMenuAPI) List(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (navigationMenuAPI) Item(props NavigationMenuItemProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
