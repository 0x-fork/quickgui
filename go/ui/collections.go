...
func (tableAPI) Header(props TableHeaderProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tableAPI) Row(props TableRowProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tableAPI) Cell(props TableCellProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (treeAPI) Row(props TreeRowProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
