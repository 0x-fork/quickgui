...
func (tabsAPI) List(props PartProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tabsAPI) Tab(props TabsTabProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tabsAPI) Indicator(props TabsIndicatorProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
...
func (tabsAPI) Panel(props TabsPanelProps, children ...any) *native.Node {
	props.Children = withPartChildren(props.Children, children)
