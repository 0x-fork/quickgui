...
//
// Go loads a prebuilt Rust shared library in-process so application builds are
// ordinary Go builds with CGO disabled.
// Call [Load] once before any other host function, typically from [github.com/egoist/quickgui/go/native.Run].
package host
