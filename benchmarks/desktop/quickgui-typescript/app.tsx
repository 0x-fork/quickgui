...
const Caption = (props: NativeProps) => (
  <Text {...props} style={[props.style, { fontSize: 12, lineHeight: 18, textColor: muted }]} />
);
...
const Property = (props: { label: string; value: string }) => (
  <View style={[row, { justifyContent: "space-between" }]}>
    ...
    <Text style={{ fontSize: 12, fontWeight: 500 }}>{props.value}</Text>
  </View>
);
...
function IssueTracker() {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: 700, paddingLeft: 12, marginBottom: 6 }}>
          Orbit
        </Text>
        <Caption style={{ paddingLeft: 12, marginBottom: 24 }}>Product workspace</Caption>
        ...
        <Caption style={{ padding: 12 }}>{"September cycle\n4 projects · 5 teammates"}</Caption>
      </View>
      <View style={[column, { flexGrow: 1, flexBasis: 0 }]}>
        ...
        >
          <View style={[column, { gap: 6 }]}>
            <Text style={{ fontSize: 24, fontWeight: 700 }}>Issue inbox</Text>
            <Caption>
        ...
        <View style={[row, { flexGrow: 1, flexBasis: 0, minHeight: 0, alignItems: "stretch" }]}>
            ...
            <For each={[`${state.query()}|${state.filter()}|${state.page()}`]}>
              {() => (
                <View style={[column, { flexGrow: 1, flexBasis: 0, overflowY: "scroll" }]}>
                  <For
                    each={state.visible()}
                    fallback={<Caption style={{ padding: 20 }}>No matching issues</Caption>}
                  >
                    {(index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Text style={{ fontSize: 11, textColor: muted, whiteSpace: "nowrap" }}>
          ...
          >
            <View style={[column, { flexShrink: 0 }]}>
              ...
              <Text style={{ fontSize: 13, lineHeight: 20, marginBottom: 22 }}>
                {state.current().description}
              </Text>
              <Text style={{ fontSize: 12, fontWeight: 600, marginBottom: 8 }}>Working notes</Text>
              <TextInput
                multiline
              ...
              <Text style={{ fontSize: 11, textColor: muted, marginTop: 10 }}>
