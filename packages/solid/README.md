...
and retained core `Markdown` host components, plus `App`, `Window`, and `render`. Import reactive
primitives from `solid-js` itself.
...
streaming Markdown with the Vercel AI SDK and DeepSeek.
